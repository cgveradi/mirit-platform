...
const visualResources = [
  ...
  {
    src: "/images/classroom/russian-daily-routine-verbs-morning-to-night.jpeg",
    width: 1024,
    height: 1280,
    titleKey: "dailyRoutineSequenceTitle",
    summaryKey: "dailyRoutineSequenceSummary",
    altKey: "dailyRoutineSequenceAlt",
    layout: "portrait",
  },
] as const;
